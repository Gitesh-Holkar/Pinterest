...
const Create = () => {
    ...
    const [filePrev, setFilePrev] = useState(""); // file preview
    ...
    const handleClick = () => {
        inputRef.current.click(); //getting reference from input
    }
    ...
    const addPinHandler=(e)=>{
        setEnabled(true);
        if (confirm("Are you sure, you want to add this pin.")){
        e.preventDefault();
                    ...
                    <div className="flex flex-col items-center justify-center w-80 h-auto p-6 bg-white rounded-lg shadow-lg">
                        ...
                        <div className="flex flex-col items-center justify-center h-full cursor-pointer" onClick={handleClick}>
                            <input
                                ref={inputRef}
                                type="file"
                                accept="image/*" // only image will accepted
                                className="hidden"
                        ...
                        <p className="mt-4 text-sm text-gray-400">
                            we recomment using high quality .jpg files but less than 10mb </p>
                    </div>
                </div>
                <div>
                    <div className="flex items-center justify-center bg-gray-100">
                        <form className="w-full max-w-lg p-6 bg-white rounded-lg shadow-lg"  onSubmit={addPinHandler}>
                            ...
                            <button type='submit' className="common-btn" disabled={enabled} >Add+</button>
