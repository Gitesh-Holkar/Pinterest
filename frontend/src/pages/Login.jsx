...
const Login = () => {
    ...
    const {fetchPins}= pinData(); // it is used to render automatically all pins without reloading, whenever we login. And we can't use it in context that's why we are using in pages and send it as a parameter in context 

    const navigate = useNavigate();

    const submitHandler = (e) => {
        e.preventDefault(); // prevent from default reloading during submit
  ...
  return (
    ...
    <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md ">
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Pinterest-logo.png/600px-Pinterest-logo.png" alt="Pinterest" 
        className='h-12'/>
    </div>
